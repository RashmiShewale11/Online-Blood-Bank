            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu" href="bloodbank.php"><i class="fa fa-desktop"></i>Blood Bank</a>
                    </li>
					<li>
							...
							if(mysqli_num_rows($res1)>=0)
							{
								...
								?>	
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="approvebank.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email'] ?>" title="approve" class="btn btn-info glyphicon glyphicon-edit"> Approve</a>&nbsp; &nbsp;<a href="deletebank.php?id=<?php echo $row['id']; ?>" title="Delete" class="btn btn-danger glyphicon glyphicon-trash"> </a></td>
                                        </tr>
                                        <?php
                                }
							}
