...
?>
                   <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <td>image</td><td><img src="slider/<?php echo $row['img']; ?>" style="width:100; height:100px" /><br /><input type="file"
 name="photo" /></td></tr>
                            <tr><td>Menu Description</td><td><textarea name="des"><?php echo $row['description'] ?></textarea></td></tr>
...
$temp=$_FILES['photo']['tmp_name'];
	if($name)
		...
		$sql="update slider set description='".$_POST['des']."',img=
		'".$userpic."' where id='".$_GET['id']."'";
		echo $sql;
