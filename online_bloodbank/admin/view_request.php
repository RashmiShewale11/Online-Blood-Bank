         ...
         <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a  class="active-menu" href="view_request.php"><i class="fa fa-desktop"></i>View Request</a>
                    </li>
                    <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div style="overflow:scroll">
							...
							<?php
						$q="select @a:=@a+1 serial_number,name,gender,age,mobile_no,blood_group,email,date,details from blood_request,(select @a:=0) AS a";
