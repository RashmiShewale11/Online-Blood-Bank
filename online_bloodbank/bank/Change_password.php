...
<body>
	...
	<!-- navigation -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					...
					<li>
                    <a  class="active"  href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Setting <span class="caret"></span></a>
		...
		<section class="agileits about-page">
			<div class="container">
                ...
                <div class="col-md-8 w3ls-about-top-left-grid">
					<div class="panel panel-primary" style="color:#000">
  					<div class="panel-heading" align="center" style="font-size:24px">Change Password</div>
  					<div class="panel-body">
    					<?php
		  if(isset($_POST['change']))
		  {
			$query='select * from blood_bank where email="'.$_SESSION['email'].'" and password="'.$_POST['pass'].'"';
			...
			if(mysqli_num_rows($res)>0)
			{
				if(strlen($_POST['pass1'])>=6)
				{
					...
					{
					$query1='update blood_bank set password="'.$_POST['pass1'].'" where email="'.$_SESSION['email'].'"';
          ...
          <br>
        <form class="form-horizontal" method="post" id="formId"enctype="multipart/form-data">
 <div class="form-group">
    <label for="exampleInputplace"class="col-sm-3 control-label" style="color:#000">Enter Old Password</label>
    <div class="col-sm-6">
    <input type="password" class="form-control validate[required]" id="exampleInputplace" placeholder="Enter Old Password" name="pass">
    </div>
  </div>
  
  <div class="form-group">
    <label for="exampleInputadd" class="col-sm-3 control-label" style="color:#000"> Enter New Password</label>
    <div class="col-sm-6">
    <input type="password" class="form-control validate[required]" id="exampleInputaddress" placeholder="Enter New Password" name="pass1">
  </div>
  </div>
  <div class="form-group">
    <label for="exampleInputadd" class="col-sm-3 control-label" style="color:#000"> Enter Re-Enter New Password</label>
    <div class="col-sm-6">
    <input type="password" class="form-control validate[required]" id="exampleInputaddress" placeholder="Enter Re-Enter New Password" name="pass2">
  </div>
  </div>
  <div class="form-group">
   <div class=" col-sm-12" align="center">
      <button type="submit" class="btn btn-success glyphicon glyphicon-saved" name="change" > Change Password</button>
                      ...
                      <?php /*?>  <form method="post" enctype="multipart/form-data" id="registrationForm">
						...
						$query="insert into donation(camp_id,date,unit,details,email)values('".$_POST['camp_id']."','".$_POST['date']."','".$_POST['units']."','".$_POST['details']."','".$_SESSION['email']."')";
