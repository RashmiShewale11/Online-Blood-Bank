		...
		$_SESSION['id']=$_GET['id'];
		 ...
		 $_SESSION['email']=$_GET['email'];
                    ...
                    <?php /*?>       
						...
						$query="insert into donation(donor_id,donor_name,age,blood_group,mobile_no,date,unit,details)values('".$_POST['donor_id']."','".$_POST['donor_name']."','".$_POST['age']."','".$_POST['blood_group']."','".$_POST['mobile_no']."','".$_POST['date']."','".$_POST['units']."','".$_POST['details']."')";
