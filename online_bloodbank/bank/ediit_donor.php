...
<body>
	...
	<!-- navigation -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
                    ...
                    <li><a class="active" href="view_donor.php">View Donor</a></li>
		...
		<section class="agileits about-page">
			<div class="container">
				<h2 class="agile-inner-title">Donor Details
 </h2>
                ...
                <div class="col-md-8 w3ls-about-top-left-grid">
					...
					?>
                       ...
                       <tr style="background-color:#000"><td colspan="2" align="center" style="color:#FFF">Donor Details</td></tr>
                        <tr><td>Donor Name</td><td><input type="text" class="form-control validate[required]" name="donor_name" value="<?php echo $row['donor_name']; ?>"></td></tr>
                        <tr><td>Mobile </td><td><input type="text" name="mobile" class="form-control" maxlength="10" value="<?php echo $row['mobile_no']; ?>"></td></tr>
                        <tr><td>Email </td><td><input type="email" name="email" class="form-control"  value="<?php echo $row['email']; ?>"></td></tr>
                        <tr><td>Address</td><td><textarea class="form-control validate[required]" name="details"><?php echo $row['address']; ?></textarea></td></tr>
                        <tr style="background-color:#000; color:#FFF"><td colspan="2" align="center" style="color:#FFF">Medical Details</td></tr>
                         <tr><td>Weight </td><td><input type="text" name="weight" class="form-control"  value="<?php echo $row['weight']; ?>"></td></tr>
                        <tr><td>Hb </td><td><input type="text" name="hb" class="form-control"  value="<?php echo $row['hb']; ?>"></td></tr>
                       <tr><td>WBC </td><td><input type="text" name="wbc" class="form-control"  value="<?php echo $row['wbc']; ?>"></td></tr>

                        <tr><td>RBC </td><td><input type="text" name="rbc" class="form-control"  value="<?php echo $row['rbc']; ?>"></td></tr>
<tr>
<td>I have not suffered from #
</td><td> 
 
 
 <input type="checkbox" name="condition_of_disease[]" value="Hepatitis B or C">Hepatitis B, C
 <input type="checkbox" name="condition_of_disease[]" value="AIDS">AIDS
 <input type="checkbox" name="condition_of_disease[]" value="Cancer">Cancer
 <input type="checkbox" name="condition_of_disease[]" value="Kidney disease">Kidney disease
<input type="checkbox" name="condition_of_disease[]" value=" Heart disease">Heart disease
</td>
</tr>
						...
						if(isset($_POST['save']))
						{
							$condition_of_disease = implode(",", $_POST['condition_of_disease']);	
						$query='update donor_registration set weight="'.$_POST['weight'].'", hb="'.$_POST['hb'].'",
						wbc="'.$_POST['wbc'].'",rbc="'.$_POST['rbc'].'",condition_of_disease="'.$condition_of_disease.'" where id="'.$_GET['id'].'"';
						$res=mysqli_query($con,$query) or die(mysqli_error($con));
						if($res)
						{
							echo "<script>";
							echo "alert('Information Updated Successfully');";
							echo "window.location.href='view_donor.php';";
							echo "</script>";
						}
						else
						{
							echo "<script>";
							echo "alert('Information Not Updated ');";
							echo "window.location.href='view_donor.php';";
							echo "</script>";
						}
					}
