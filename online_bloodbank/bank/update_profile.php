                ...
                <div class="col-md-8 w3ls-about-top-left-grid">
                    ...
                    <?php
                        ...
                        <tr><td>Type</td><td><input type="text" class="form-control validate[required]" name="type" value="<?php echo $row['type']; ?>"></td></tr>
                         <tr><td>Bank Name</td><td><input type="text" class="form-control validate[required]" name="bankname" value="<?php echo $row['bankname']; ?>"></td></tr>
                          <tr><td>Contact Person</td><td><input type="text" class="form-control validate[required]" name="contact_person" value="<?php echo $row['contact_person']; ?>"></td></tr>
                         
                            <tr><td>Contact No</td><td><input type="text" class="form-control validate[required]" maxlength="10" name="contactno" value="<?php echo $row['contactno']; ?>"></td></tr>
