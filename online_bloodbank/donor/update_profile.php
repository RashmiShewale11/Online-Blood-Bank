		...
		<section class="agileits about-page">
			<div class="container">
                ...
                <div class="col-md-8 w3ls-about-top-left-grid">
                    ...
                    <?php
						$q="select * from donor_registration where email='".$_SESSION['email']."'";
                        ...
                        <tr><td>Gender</td><td>
                        <input name="gender" type="radio" value="Male"  <?php if($gender=="Male"){ echo "checked" ;}  ?>> Male &nbsp;&nbsp;&nbsp;<input name="gender" checked="checked" type="radio" value="Female" <?php if($gender=="Female"){ echo "checked" ;}  ?> /> Female<br/> 
                      <?php /*?>  <input type="radio" name="gender" value="Male<?php if($row['gender']=='Male') echo 'checked="checked"';?>"  >Male&nbsp;&nbsp;&nbsp;<input type="radio" class="" name="gender" value="Female<?php if($row['gender']=='Female') echo 'checked="checked"';?>" >Female<?php */?></td></tr>
                        <tr><td>Age</td><td><input type="text" class="form-control validate[required]" name="age"  value="<?php echo $row['age']; ?>"></td></tr>
                        <tr><td>Mobile No</td><td><input type="text" class="form-control  validate[optional,custom[integer],minSize[10],maxSize[12]]" name="mobile_no" value="<?php echo $row['mobile_no']; ?>" maxlength="10"></td></tr>
                        
                        
                        <tr><td>Profile Image</td><td><img src="../profile/<?php echo $row['img']; ?>" style="width:200px; height::200px"><input type="file" class="form-control" name="photo"></td></tr>
...
$temp=$_FILES['photo']['tmp_name'];
	if($name)
		...
		$sql='update donor_registration set donor_name="'.$_POST['donor_name'].'",gender="'.$_POST['gender'].'",age="'.$_POST['age'].'",mobile_no="'.$_POST['mobile_no'].'",img="'.$userpic.'" where email="'.$_SESSION['email'].'"';
		echo $sql;
