...
<body>
	...
	<!-- navigation -->
			<nav class="navbar navbar-default">
			  <div class="container-fluid">
				...
				<ul class="nav navbar-nav">
                    ...
                    <li><a class="active" href="view_donation.php">View Donation</a></li>
		...
		<section class="agileits about-page">
			<div class="container">
				<h2 class="agile-inner-title">VIEW DONATION</h2>
                ...
                <div class="col-md-10 w3ls-about-top-left-grid">
					<div class="panel panel-primary" style="color:#000">
  					<div class="panel-heading" align="center" style="font-size:24px">View Donation</div>
  					<div class="panel-body">
                       ...
                       <th>Details</th>
						...
						<?php
						$q="select * from donation where donor_id='".$_SESSION['id']."' and donor_name='".$_SESSION['donor_name']."'";
