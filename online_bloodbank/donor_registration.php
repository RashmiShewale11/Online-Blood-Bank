...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script> <!----This link is important for dependent drop drop----------------->
                        ...
                        <tr><td>Donor Name</td><td><input type="text" class="form-control validate[required]" name="donor_name" required ></td></tr>
                        ...
                        <tr><td>Age</td><td><input type="text" class="form-control validate[required]" name="age" required></td></tr>
                        <tr><td>Mobile No</td><td><input type="text" class="form-control  validate[optional,custom[integer],minSize[10],maxSize[12]]" maxlength="10" name="mobile_no" required></td></tr>
                        <tr><td>Blood Group</td><td><select name="blood_group" class="form-control validate[required]" required>
      ...
      <tr>
                <td>State</td>
                 <td>
                    <select class=" c form-control validate[required] " name="state"  id="state" required>
            ...
            <tr>
                <td>District</td>
                 <td>
                    <select class="form-control validate[required]" id="district" name="district" required>
		  ...
		  <option value="" selected="selected" >--Taluka--</option>
                        ...
                        <tr><td>Email</td><td><input type="email" class="form-control validate[required,custom[email]]" name="email" required></td></tr>
                        <tr><td>Password</td><td><input type="password" class="form-control validate[required,minSize[6]]" name="password" required></td></tr>
                        <tr><td>Confirm Password</td><td><input type="password" class="form-control validate[required,minSize[6],equals[txt_password]]" name="cpassword" required></td></tr>
