...
<body>
	...
	<!-- navigation -->
		...
		<section class="agileits about-page">
			<div class="container">
				<h2 class="agile-inner-title">Donor Login</h2>
                ...
                <div class="col-md-6 w3ls-about-top-left-grid">
					<div class="panel panel-primary" style="color:#000">
  					<div class="panel-heading" align="center" style="font-size:24px">Login</div>
  					<div class="panel-body">
    					<form method="post" enctype="multipart/form-data" id="registrationForm">
                        <table class=" table table-bordered table-responsive" style="color:#000">
                        <tr><td> Email Id</td><td><input type="email" class="form-control validate[required]" name="email" placeholder="abc@gmail.com"></td></tr>
                        <tr><td>Password</td><td><input type="password" name="password" class="form-control validate[required]" placeholder="*****"   ></td></tr>
                        
                        
                        <tr><td colspan="2" align="center"><input type="submit" name="save" value="Login" class="btn btn-success"> &nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="Clear" class="btn btn-danger"></td></tr>
                        </table>
                        </form>
                        <?php
						...
						if(isset($_POST['save']))
						{
							...
							$query='select * from donor_registration where email="'.$_POST['email'].'" and password="'.$_POST['password'].'" ';
...
{	
	...
	echo'window.location.href="donor/index.php"';
	echo'</script>';
}
else
{
	echo"<script>";
	echo"alert('Invalid Username and Password!Try again');";
