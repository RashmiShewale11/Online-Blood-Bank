			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				 <ul class="nav navbar-nav">
                    ...
                    <li><a href="send_request.php" class="active">Send Request</a></li>
                ...
                <div class="col-md-8 w3ls-about-top-left-grid">
					<div class="panel panel-primary" style="color:#000">
  					...
  					<div class="panel-body">
                        ...
                        <tr><td> Name</td><td><input type="text" class="form-control validate[required]" name="name"></td></tr>
                        ...
                        <tr><td>Mobile No</td><td><input type="text" class="form-control  validate[optional,custom[integer],minSize[10],maxSize[12]]" maxlength="10" name="mobile_no"</td></tr>
                        ...
                        <tr><td>Till Required Date</td><td><input type="date" class="form-control validate[required,minSize[6]]" name="date" ></td></tr>
                        <tr><td>Details</td><td><textarea class="form-control validate[required]" name="details"></textarea></td></tr>
                        
                        <tr><td colspan="2" align="center"><input type="submit" name="save" value="Send Request" class="btn btn-success"> &nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="Clear" class="btn btn-danger"></td></tr>
                        </table>
                        </form>
                        <?php
						...
						$query="insert into blood_request(name,gender,age,mobile_no,blood_group,email,date,details)values('".$_POST['name']."','".$_POST['gender']."','".$_POST['age']."','".$_POST['mobile_no']."','".$_POST['blood_group']."','".$_POST['email']."','".$_POST['date']."','".$_POST['details']."')";
