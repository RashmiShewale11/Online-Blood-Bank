...
<body>
	...
	<!-- navigation -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
                    ...
                    <li><a class="active" href="view_request.php">View Request</a></li>
		...
		<section class="agileits about-page">
			<div class="container">
				<h2 class="agile-inner-title">View Blood Request</h2>
                ...
                <div class="col-md-10 w3ls-about-top-left-grid">
					<div class="panel panel-primary" style="color:#000">
  					<div class="panel-heading" align="center" style="font-size:24px">View Blood Request</div>
